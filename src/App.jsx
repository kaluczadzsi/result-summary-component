const App = () => {
  return (
    <main>
      <div className="card sm:h-screen sm:justify-center sm:items-center sm:max-w-[1440px] sm:flex font-hanken font-medium">
        ...
        <figure className="px-6 summary py-6 flex flex-col">
