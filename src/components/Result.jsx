const Result = () => {
  return (
    <figure className="figure sm:py-8 self-stretch sm:rounded-[25px] sm:  sm:flex-1 rounded-bl-[30px] rounded-br-[30px] results bg-gradient-to-b from-light-slate-blue to-light-royal-blue flex flex-col py-6 justify-center items-center">
      <header className="text-light-lavender mb-4 sm:mb-0 text-xl">
        Your Result
      </header>
      ...
      <p className="mt-4 mb-2 text-white  sm:mb-0 sm:text-3xl">Great</p>
      <p className="sm:text-[16px] text-center mb-2  text-[14px] w-[60%] m-auto text-light-lavender opacity-[0.8]">
